...
import DefaultBackgroundImg from '../img_Bg.png';
        ...
        <>
            <Box
                style={{
                    ...
                    boxShadow: '0px 30px 30px 30px #ffffff',
                    borderRadius: '35px'
                }}
                sx={{ position: 'absolute', filter: 'blur(0px)', zIndex: -1, bottom: 0 }}
            ></Box>
            {/* <Image
                    width="100%"
                    // height="100%"
                    height="calc(100vh - 115px)"
                    src={DefaultBackgroundImg}
                /> */}
