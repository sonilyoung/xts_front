...
const items = [
    ...
    getItem('학습 관리', 'sub2', <AppstoreAddOutlined />, [
        getItem('교육 모듈구성', 'g5', <BlockOutlined />, [
            ...
            getItem(<Link to="/learning/curriculum">커리큘럼 관리</Link>, '10', <FileTextOutlined />)
        ]),
        getItem(<Link to="/learning/xraypoint">X-ray 판독 배점관리</Link>, '11', <BlockOutlined />),
        getItem(<Link to="/learning/edutype">교육 타입관리</Link>, '12', <BlockOutlined />)
    ]),

    getItem('교육 관리', 'sub3', <AppstoreAddOutlined />, [
        getItem('교육과정 관리', 'g6', <BlockOutlined />, [
            getItem(<Link to="/educurriculum/edugroup">그룹 관리</Link>, '13', <FileTextOutlined />),
            getItem(<Link to="/educurriculum/educlass">과정 분류</Link>, '14', <FileTextOutlined />),
            getItem(<Link to="/educurriculum/eduproc">과정 등록</Link>, '15', <FileTextOutlined />)
        ]),
        getItem('교육차수 관리', 'g7', <BlockOutlined />, [
            getItem(<Link to="/educurriculum/edubaseline">차수 등록</Link>, '16', <FileTextOutlined />),
            getItem(<Link to="/educurriculum/edubaselinemenu">차수별 메뉴관리</Link>, '17', <FileTextOutlined />)
        ]),
    ...
    getItem('교육생 관리', 'sub4', <AppstoreAddOutlined />, [
        ...
        getItem(<Link to="/student/baseline">교육생 차수관리</Link>, '19', <FileTextOutlined />)
    ...
    getItem('통계', 'sub6', <AppstoreAddOutlined />, [
        getItem('교육실적조회', 'g8', <BlockOutlined />, [
            ...
            getItem(<Link to="/statistics/educationaleval">교육평가 조회</Link>, '27', <FileTextOutlined />),
            getItem(<Link to="/statistics/wronganswerrate">문제별 오답률 조회</Link>, '28', <FileTextOutlined />),
            // getItem('설문조사 결과 조회', '29', <FileTextOutlined />),
            getItem(<Link to="/statistics/traineeevaluation">교육생 평가 조회</Link>, '30', <FileTextOutlined />)
        ]),
        getItem('최종평가조회', 'g9', <BlockOutlined />, [
            getItem(<Link to="/statistics/traineescoreranking">교육생 점수 순위조회</Link>, '31', <FileTextOutlined />),
            getItem(<Link to="/statistics/evaluationscoreby">기관별 평가 점수 조회</Link>, '32', <FileTextOutlined />),
            getItem(<Link to="/statistics/annualtraining">연도/회차별 교육평균 조회</Link>, '33', <FileTextOutlined />)
        ])
    ]),
